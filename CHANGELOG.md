...
* TS migration: victory-primitives by @scottrippey in https://github.com/tiennguyen-ftu-k52/victory/pull/2274
...
* add box plot jest/rtl tests by @heythisispaul in https://github.com/tiennguyen-ftu-k52/victory/pull/2225
...
-[#1767](https://github.com/tiennguyen-ftu-k52/victory/pull/1767) - Adds support for `rx` and `ry` props on the `Background` primitive component. Thanks @NgoKnows!
...
- [#1709](https://github.com/tiennguyen-ftu-k52/victory/pull/1709) - Adds default `onFocus` and `onBlur` event handlers to `VictoryTooltip` so that users can trigger tooltips by tabbing through the chart elements when `tabIndex` is set.
...
-[#1607](https://github.com/tiennguyen-ftu-k52/victory/pull/1607) - Add missing containerRef type. Thanks @NgoKnows!
...
- [#1572](https://github.com/tiennguyen-ftu-k52/victory/pull/1572) - Add missing `backgroundComponent` type
...
- [#1375](https://github.com/tiennguyen-ftu-k52/victory/pull/1375) - Evaluates / calculates some props early so they are available when functional props are being evaluated. Most notably, `text` is evaluated before any other functional props for `VictoryLabel` so it may be used to determine things like style, etc.
...
Related PR: [#1365](https://github.com/tiennguyen-ftu-k52/victory/pull/1365)
...
[#1306](https://github.com/tiennguyen-ftu-k52/victory/pull/1306) - Calls `eventKey` functions with both `datum` and `index`
...
- [284](https://github.com/tiennguyen-ftu-k52/victory-core/pull/284) Sort arrays by "key" when animating. See [#684](https://github.com/tiennguyen-ftu-k52/victory/issues/684)
- [274](https://github.com/tiennguyen-ftu-k52/victory-core/pull/274) Fixes automatic bar width calculation for horizontal bars
- [275](https://github.com/tiennguyen-ftu-k52/victory-core/pull/275) Adds an optional `containerId` prop for all Victory containers
- [276](https://github.com/tiennguyen-ftu-k52/victory-core/pull/276) Adds `downsample` method for `Data`

VictoryChart

- [504](https://github.com/tiennguyen-ftu-k52/victory-chart/pull/504) bugfix: padding bug in `VictoryCursorContainer`
- [505](https://github.com/tiennguyen-ftu-k52/victory-chart/pull/505) Support touch events on all containers
- [506](https://github.com/tiennguyen-ftu-k52/victory-chart/pull/506) Add `props` argument for `VictoryVoronoiContainer` callbacks
- [507](https://github.com/tiennguyen-ftu-k52/victory-chart/pull/507) bugfix: Support array styles for `VictoryLabel` when it is used as a direct child of `VictoryChart` or other wrappers
- [508](https://github.com/tiennguyen-ftu-k52/victory-chart/pull/508) Add support for `animate` as a boolean prop
- [509](https://github.com/tiennguyen-ftu-k52/victory-chart/pull/509) Add `props` as the last argument for all container callbacks
- [502](https://github.com/tiennguyen-ftu-k52/victory-chart/pull/502) Fix bug in `VictoryZoomContainer`
- [503](https://github.com/tiennguyen-ftu-k52/victory-chart/pull/503) Add downsample option for `VictoryZoomContainer`
- [504](https://github.com/tiennguyen-ftu-k52/victory-chart/pull/504) Fix padding bug in `VictoryCursorContainer`

VictoryPie

- [151](https://github.com/tiennguyen-ftu-k52/victory-pie/pull/151) bugfix: support functional padding for labels
- [152](https://github.com/tiennguyen-ftu-k52/victory-pie/pull/152) Support boolean animate prop

## 0.21.3 (2017-07-24)

VictoryCore

- [267](https://github.com/tiennguyen-ftu-k52/victory-core/pull/267) Correct single-point domain logic
- [268](https://github.com/tiennguyen-ftu-k52/victory-core/pull/268) Correct stacked domain logic
- [269](https://github.com/tiennguyen-ftu-k52/victory-core/pull/269) `VictoryLabel` accepts percentage values for `x` and `y`
- [270](https://github.com/tiennguyen-ftu-k52/victory-core/pull/270) `VictoryLegend` supports events. Also enforces consistent parent styles as other Victory components. **Breaking style change for VictoryLegend**
- [272](https://github.com/tiennguyen-ftu-k52/victory-core/pull/272) Aggressive `shouldComponentUpdate` logic for evented Victory components **Breaking change for some components using `addEvents`**

VictoryChart

- [496](https://github.com/tiennguyen-ftu-k52/victory-chart/pull/496) `VictoryZoomContainer` improvements for real-time, updating data
- [497](https://github.com/tiennguyen-ftu-k52/victory-chart/pull/497) bugfix: apply `domainPadding` to explicit domains
- [498](https://github.com/tiennguyen-ftu-k52/victory-chart/pull/498) `VictoryAxis` determines its own default `tickFormat`
- [499](https://github.com/tiennguyen-ftu-k52/victory-chart/pull/499) Fix label prop merge order for `VictoryVoronoiContainer` labels
- [500](https://github.com/tiennguyen-ftu-k52/victory-chart/pull/500) Support performance improvements for evented components _e.g._ `VictoryArea`, `VictoryBar` ...

## 0.21.2 (2017-07-13)

Victory:

- [651](https://github.com/tiennguyen-ftu-k52/victory/pull/651) Support Webpack 3 and ES6 exports

VictoryCore:

- [266](https://github.com/tiennguyen-ftu-k52/victory-core/pull/266) Support Webpack 3 and ES6 exports
- [265](https://github.com/tiennguyen-ftu-k52/victory-core/pull/265) Translates `Slice` when an `origin` prop is given

VictoryChart:

- [495](https://github.com/tiennguyen-ftu-k52/victory-chart/pull/495) Support Webpack 3 and ES6 exports
- [494](https://github.com/tiennguyen-ftu-k52/victory-chart/pull/494) Ensure that `tickFormat` has access to `tick`, `index`, and `ticks`
- [491](https://github.com/tiennguyen-ftu-k52/victory-chart/pull/491) Corrects dependent axis for `innerRadius`
- [490](https://github.com/tiennguyen-ftu-k52/victory-chart/pull/490) Fixes a bug in domain calculation for polar axes
- [488](https://github.com/tiennguyen-ftu-k52/victory-chart/pull/488) `VictoryZoomContainer` only updates the domain in the dimension it controls
- [489](https://github.com/tiennguyen-ftu-k52/victory-chart/pull/489) Adds support for `innerRadius` on polar charts

VictoryPie:

- [149](https://github.com/tiennguyen-ftu-k52/victory-pie/pull/149) Support Webpack 3 and ES6 exports
- [148](https://github.com/tiennguyen-ftu-k52/victory-pie/pull/148) Translates individual slices rather than an entire group translation for pie and labels
...
- [victory-core/255](https://github.com/tiennguyen-ftu-k52/victory-core/pull/255) style typo
- [victory-core/257](https://github.com/tiennguyen-ftu-k52/victory-core/pull/257) single point domain calculation bug
- [victory-core/259](https://github.com/tiennguyen-ftu-k52/victory-core/pull/259) Area render bug
- [victory-core/260](https://github.com/tiennguyen-ftu-k52/victory-core/pull/260) Area render order
- [victory-core/515](https://github.com/tiennguyen-ftu-k52/victory/issues/515) Bugfix for ARIA title and desc. Now both have unique IDs.
- [victory-core/262](https://github.com/tiennguyen-ftu-k52/victory-core/pull/262) Consistent widths for polar bars. **This change may require style adjustments to maintain visual continuity**

VictoryChart

- [victory-chart/482](https://github.com/tiennguyen-ftu-k52/victory-chart/pull/482) Add `minBubbleSize` prop to `VictoryScatter`
- [victory-chart/484](https://github.com/tiennguyen-ftu-k52/victory-chart/pull/484) Remove inappropriate interpolation options for `VictoryArea` and `VictoryLine`
- [victory-chart/487](https://github.com/tiennguyen-ftu-k52/victory-chart/pull/487) Fix a bug in `VictoryPolarAxis` domain calculation

## 0.21.0 (2017-06-06)

- [victory-core/240](https://github.com/tiennguyen-ftu-k52/victory-core/pull/240) Polar Charts
- [victory-chart/466](https://github.com/tiennguyen-ftu-k52/victory-chart/pull/466) Polar Charts
- [victory-chart/475](https://github.com/tiennguyen-ftu-k52/victory-chart/pull/475) Brush and Zoom fixes
- [victory-chart/476](https://github.com/tiennguyen-ftu-k52/victory-chart/pull/476) Zoom Improvements
...
**Breaking Changes** -[victory-chart/471](https://github.com/tiennguyen-ftu-k52/victory-chart/pull/471) Passes the string value of ticks to the `tickFormat` function rather than the associated index. _This may be a breaking change for users who are using categorical data and formatting tick values by index_

**New Features** -[victory-chart/474](https://github.com/tiennguyen-ftu-k52/victory-chart/pull/474) Adds support for a y0 accessor so that users can have granular control over the baseline of components like `VictoryArea` -[victory-core/246](https://github.com/tiennguyen-ftu-k52/victory-core/pull/246) Adds an `itemsPerRow` prop to `VictoryLegend` to support automatic legend wrapping

**Minor Changes** -[victory-chart/472](https://github.com/tiennguyen-ftu-k52/victory-chart/pull/472) Fixes a bug that was causing `VictoryGroup` to override styles on any independent `VictoryLabel` children -[victory-core/244](https://github.com/tiennguyen-ftu-k52/victory-core/pull/244) Passes missing `datum` and `index` props to `Flyout` -[victory-chart/250](https://github.com/tiennguyen-ftu-k52/victory-core/pull/250) Audits `shouldComponentUpdate` logic for all primitive components so that changes to optional props like `className` will cause components to re-render. -[victory-pie/146](https://github.com/tiennguyen-ftu-k52/victory-pie/pull/146) Rounds label positions for `VictoryPie`

## 0.19.1 (2017-05-12)

- [victory-chart/469](https://github.com/tiennguyen-ftu-k52/victory-chart/pull/469) Adds `VictoryCursorContainer`
- [victory-core/241](https://github.com/tiennguyen-ftu-k52/victory-core/pull/241) Adds optional `title` an `desc` props to `VictoryLabel`
- [victory-core/243](https://github.com/tiennguyen-ftu-k52/victory-core/pull/243) Improvements to `VictoryContainer`
...
- [victory-core/244](https://github.com/tiennguyen-ftu-k52/victory-core/pull/244) adds missing `index` and `datum` props to `Flyout`
- [victory-core/245](https://github.com/tiennguyen-ftu-k52/victory-core/pull/245) fixes `dy` calculation in `VictoryLabel`
...
- For more detail, see [victory-chart/453](https://github.com/tiennguyen-ftu-k52/victory-chart/pull/453)

## 0.18.3 (2017-03-21)

[victory-chart/447](https://github.com/tiennguyen-ftu-k52/victory-chart/pull/447) Improves performance for container components

- Fixes [#511](https://github.com/tiennguyen-ftu-k52/victory/issues/511)
- Fixes [#526](https://github.com/tiennguyen-ftu-k52/victory/issues/526)

## 0.18.2 (2017-03-15)

Minor bug fixes -[508](https://github.com/tiennguyen-ftu-k52/victory/issues/508) -[509](https://github.com/tiennguyen-ftu-k52/victory/issues/509) -[510](https://github.com/tiennguyen-ftu-k52/victory/issues/510) -[517](https://github.com/tiennguyen-ftu-k52/victory/issues/517) -[520](https://github.com/tiennguyen-ftu-k52/victory/issues/520)

## 0.18.1 (2017-03-14)

[518](https://github.com/tiennguyen-ftu-k52/victory/pull/518)
...
[victory-core/196](https://github.com/tiennguyen-ftu-k52/victory-core/pull/196)
...
[victory-core/201](https://github.com/tiennguyen-ftu-k52/victory-core/pull/201)

- implements data sorting for all components with a `sortKey` props

[victory-chart/432](https://github.com/tiennguyen-ftu-k52/victory-chart/pull/432)
...
[victory-chart/438](https://github.com/tiennguyen-ftu-k52/victory-chart/pull/438)
...
[victory-core/207](https://github.com/tiennguyen-ftu-k52/victory-core/pull/207)
...
- [victory-core/195](https://github.com/tiennguyen-ftu-k52/victory-core/pull/195)
  - Fixes null event state bug
- [victory-chart/431](https://github.com/tiennguyen-ftu-k52/victory-chart/pull/431)
  - Sets a maximum amount of scale per zoom event for smoother interaction with fast onWheel events

## 0.16.1 (2017-02-03)

- [victory-chart/429](https://github.com/tiennguyen-ftu-k52/victory-chart/pull/429)
...
- [victory-core/189](https://github.com/tiennguyen-ftu-k52/victory-core/pull/189) and [191](https://github.com/tiennguyen-ftu-k52/victory-core/pull/190)
  - Adds `VictoryLegend` component
- [victory-core/190](https://github.com/tiennguyen-ftu-k52/victory-core/pull/190)
...
- [victory-chart/427](https://github.com/tiennguyen-ftu-k52/victory-chart/pull/427)
  - Adds `VictoryBrushContainer`
  - Adds `VictoryZoomContainer` to replace `VictoryZoom`
  - [See pull request for examples](https://github.com/tiennguyen-ftu-k52/victory-chart/pull/427)
...
- Uses `publishr` to reduce npm installed package size [#413](https://github.com/tiennguyen-ftu-k52/victory/issues/413)
- Fixes a bug where label padding was not being applied to tick labels [#408](https://github.com/tiennguyen-ftu-k52/victory/issues/408)
- Removes default tick padding in themes
- Changes how the domain is calculated when there is only one data point, or when the minimum and maximum of the data is equal in a given dimension [#407](https://github.com/tiennguyen-ftu-k52/victory/issues/407)
- Removes hard-coded `<g>` from `VictorySharedEvents` [#402](https://github.com/tiennguyen-ftu-k52/victory/issues/402)
...
- `victory-core` includes the [material theme](https://github.com/tiennguyen-ftu-k52/victory-core/blob/main/src/victory-theme/material.js)
...
- Changes have been made across all components in order to support [victory-native](https://github.com/tiennguyen-ftu-k52/victory-native). `VictoryNative` has an identical API to `Victory`, and reuses most of the code. Changes made to `Victory` to support `VictoryNative` are all non-breaking, and minimal. They include the addition of a `groupComponent` prop in all components (which defaults to `<g>`), removing svg transforms whenever possible in favor of absolute positioning, and code reorganization.
...
- Fixes [bugs related to log scales](https://github.com/tiennguyen-ftu-k52/victory-chart/pull/317)
- Fixes [a bug related to time scales](https://github.com/tiennguyen-ftu-k52/victory-chart/pull/318)
...
- Application dependencies like `radium` and `lodash` now live in components, not in the Builder archetype. This is a breaking change. https://github.com/tiennguyen-ftu-k52/victory/issues/176
