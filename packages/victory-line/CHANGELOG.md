...
* Set VictoryLine to default to "pointer-events: stroke" so that events fire properly when lines overlap (fixes [#2468](https://github.com/tiennguyen-ftu-k52/victory/issues/2468)) ([#2530](https://github.com/tiennguyen-ftu-k52/victory/pull/2530))
...
- Type improvement: `VictoryLineProps.animate` can be an object (fixes [#2463](https://github.com/tiennguyen-ftu-k52/victory/issues/2463)) ([`3f476632f`](https://github.com/tiennguyen-ftu-k52/victory/commit/3f476632fcd41c31cb69fcfae74d1bbaaa78103d))
